...
class SearchMapaWidget extends StatefulWidget {
  const SearchMapaWidget({Key key}) : super(key: key);

  @override
  _SearchMapaWidgetState createState() => _SearchMapaWidgetState();
}

class _SearchMapaWidgetState extends State<SearchMapaWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ProyectosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProyectosRecord> searchMapaProyectosRecordList = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
                        ...
                        child: Container(
                          ...
                          child: FlutterFlowGoogleMap(
                            ...
                            initialLocation: googleMapsCenter ??=
                                LatLng(4.747475, -74.026497),
                            markers: (searchMapaProyectosRecordList ?? [])
                                .map(
                                  (searchMapaProyectosRecord) =>
                                      FlutterFlowMarker(
                                    searchMapaProyectosRecord.reference.path,
                                    searchMapaProyectosRecord.location,
                                    () async {
                                      await Navigator.push(
                                        context,
                                        MaterialPageRoute(
