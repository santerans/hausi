...
class LightModeTheme extends FlutterFlowTheme {
  Color primaryColor = const Color(0xFFFF5001);
  Color secondaryColor = const Color(0xFF232738);
  Color tertiaryColor = const Color(0xFFF5F8FA);
  Color alternate = const Color(0xFFFF5963);
  Color primaryBackground = const Color(0xFFFFFFFF);
  Color secondaryBackground = const Color(0xFFF5F8FA);
  Color primaryText = const Color(0xFF232738);
  Color secondaryText = const Color(0xFFFF5001);
